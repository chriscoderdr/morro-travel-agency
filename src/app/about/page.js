    ...
    <div className="w-[1200px] mx-auto">
      ...
      <div className="font-gilda">
        ...
        <p className="text-lg mb-4 mt-[60px]">
          ...
          portfolio. While this company isn't real, the goal of this project is
        ...
        <h2 className="text-2xl font-semibold mb-3">What I've Implemented:</h2>
        ...
        <p className="text-lg mb-4">
          ...
          professional-quality websites that align with the client's vision. If
          you'd like to know more about my work or get in touch, feel free to
          connect with me on{" "}
          <a
